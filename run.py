...
""" TOML compliance suite runner.
    ...
    Reference: https://github.com/toml-lang/compliance/blob/master/run.py
    """
...
if __name__ == "__main__":
    ...
    # This check isn't super clear at first glance. It works since the
    # 'decoder' subparser does not have a 'decoder' argument.
