...
import sys, os, time, io, re, traceback, warnings, weakref, collections.abc, threading
    ...
    def _after_at_fork_child_reinit_locks():
        ...
        for handler in _at_fork_reinit_lock_weakset:
            try:
                ...
                print("Ignoring exception from logging atfork",
                      instance,
                      "._reinit_lock() method:",
                      err,
                      file=sys.stderr)
            ...
            for _, fieldname, spec, conversion in _str_formatter.parse(
                ...
                if fieldname:
                    if not self.field_spec.match(fieldname):
                        raise ValueError('invalid field name/expression: %r' %
                                         fieldname)
